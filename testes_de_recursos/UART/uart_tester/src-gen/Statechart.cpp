...
{
	/* Entry action for state 'StateA'. */
	timerService->setTimer(this, 0, ((static_cast<sc::time> (2)) * 1000), false);
...
{
	/* Entry action for state 'StateC'. */
	timerService->setTimer(this, 1, ((static_cast<sc::time> (2)) * 1000), false);
...
void Statechart::clearCurrentEvents() {
	current.iface.myEvent_raised = false;
	current.timeEvents.Statechart_main_region_StateA_time_event_0_raised = false;
	current.timeEvents.Statechart_main_region_StateC_time_event_0_raised = false;
}
